...
<div class="container my-24 mx-auto md:px-6 pt-[100px]">
      ...
      <div class="flex flex-wrap items-center">
        <div class="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
          <div class="h-[500px] w-full">
            <iframe src="https://media.istockphoto.com/id/959783574/id/foto/kantor-komersial-di-kota.jpg?s=612x612&w=0&k=20&c=6nkbqLDxdz4pAhxMSZqINXiwGQI94Lr2-txH1zNBGv0="
              class="left-0 top-0 h-[500px] w-[550px] rounded-t-lg lg:rounded-tr-none lg:rounded-" frameborder="0"
